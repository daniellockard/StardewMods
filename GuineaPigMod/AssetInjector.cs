...
namespace GuineaPigMod
{
    ...
    {
            public const int PoopPileId = 9001;
    public const int AdoptionCertificateId = 9002;
    
    // Fertilizer IDs (using vanilla IDs)
    public const int BasicFertilizerId = 368; // Basic Fertilizer
    ...
    public const string QualityFertilizerRecipeName = "Quality Fertilizer (Guinea Pig)";
    public const string DeluxeFertilizerRecipeName = "Deluxe Fertilizer (Guinea Pig)";
    }
} 